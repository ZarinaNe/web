...
echo increaseEnthusiasm("i love cats"), "\n";
...
echo increaseEnthusiasm(repeatThreeTimes("and dogs too")), "\n";
...
$user = array('name'=>'Zarina', 'surname' => 'Magomedova', 'patronymic' => 'Arslanalievna');
echo $user['name'], " ", $user['surname'], " ", $user['patronymic'], "\n";

$date = array('year' => 2023, 'month' => 03, 'day' => 11);
